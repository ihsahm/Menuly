...
//     var url =
//         "https://www.google.com/maps/dir/${locationProvider.passlat},${locationProvider.passlong}/${snapshot.docs[itemindex].data()['latitude']},${snapshot.docs[itemindex].data()['longitude']}/@8.9817088,38.7284248,15z";
...
//   double distance = 0;
//   var locationMessage = "";
//   var locationProvider.passlat;
//   var locationProvider.passlong;
...
//             child: Center(child: Lottie.asset('assets/sorry.json')),
//           );
//         }
//       },
//     );
